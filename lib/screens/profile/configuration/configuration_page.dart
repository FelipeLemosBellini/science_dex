    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          ScienceDexDividerWidget(padding: const EdgeInsets.only(top: 22, bottom: 18, left: 20, right: 20)),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: Text("Períodos").bodySmallSemiBold(),
          ),
          Consumer(
              builder: (context, model, child) =>
                  ListPeriodWidget(margin: EdgeInsets.only(top: 18, left: 20, right: 20))),
          ScienceDexPrimaryButton(
            padding: EdgeInsets.only(top: 12),
            onTap: () {},
            text: "ADD",
          ),
          LogoutWidget(padding: EdgeInsets.only(left: 20, top: 66), name: "João"),
          SizedBox(height: 50)
        ],
      ),
    );
