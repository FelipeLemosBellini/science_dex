...
class ScienceDexSmallNumberTextField extends StatefulWidget {
  ...
  const ScienceDexSmallNumberTextField({
    super.key,
    this.padding,
  ...
  @override
  State<ScienceDexSmallNumberTextField> createState() => _ScienceDexSmallMumberTextFieldState();
}

class _ScienceDexSmallMumberTextFieldState extends State<ScienceDexSmallNumberTextField> {
